...
5. Azure OpenAI の作成の \[**基本**\] 画面が表示されるので、各項目を以下のように入力します
    ...
    >⚠️ 現在、画像生成 AI モデル dall-e-3 は **australiaeast、eastus、swedencentral** の[いずれかのリージョンでのみ利用可能](https://learn.microsoft.com/ja-jp/azure/ai-foundry/foundry-models/concepts/models-sold-directly-by-azure?pivots=azure-openai&tabs=global-standard-aoai%2Cstandard-chat-completions%2Cglobal-standard#region-availability-7)です。ただ **eastus** は利用が多く Free の Azure のリソースが作成できない可能性もあるので、**swedencentral** を選択することをお勧めします。
