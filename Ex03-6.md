...
> [!NOTE]
> この演習は 2025 年 2 月に新たに追加された演習です。この更新でその他の演習のサンプルコードに、この演習で実装するコード用のコメントが追記されています。よって、それ以前に当ハンズオンを実施された方で、作成済みの演習用ボット アプリケーションに機能を追加される方は、以下のリンクを参照してコメントの位置を確認してください。
