...
グラウンディングは、生成 AI や大規模言語モデル（LLM）の出力を現実世界の情報源に結びつける技術です。これにより、モデルが事実に基づかない情報を生成する「ハルシネーション」を減らし、より正確で信頼性の高い応答を提供できます。
...
このグラウンディングには一般的に以下の 4 つの方法が用いられます。

* RAG (Retrieval-Augmented Generation) : 事前に用意した情報を検索して回答を生成する方法
* Function Calling : 関数を呼び出してその結果を回答に使用する方法
* コンテキスト : ユーザーのプロンプトに含まれる情報を使用する方法
* Web 検索 : Web を検索してその結果を回答に使用する方法

Web 検索は上記の 4 つの方法の中でもっとも幅広く、さまざまな情報を取得できる方法です。
...
3. 同ファイル内の **sendMessage** 関数内の以下のコメントに挟まれた範囲を
    ...
    <!--
    メモ Ex03-5.md#%E3%82%BF%E3%82%B9%E3%82%AF-2-1--aoailmjs-%E3%81%AE-sendmessage-%E9%96%A2%E6%95%B0%E3%81%AE%E5%A4%89%E6%9B%B4
    -->
...
4. Web 検索結果からの回答の生成を依頼するメッセージであったことを示すフラグ **create_answer_webSearch_flag** を設定する処理を追加します
    ...
    <!--
    Ex03-3.md#%E3%82%BF%E3%82%B9%E3%82%AF-2--%E3%83%81%E3%83%A3%E3%83%83%E3%83%88%E3%83%9C%E3%83%83%E3%83%88-%E3%82%A2%E3%83%97%E3%83%AA%E3%81%8B%E3%82%89%E3%81%AE%E9%96%A2%E6%95%B0%E3%81%AE%E5%91%BC%E3%81%B3%E5%87%BA%E3%81%97
    -->
