...
> [!NOTE]
> この演習は 2025 年 2 月に新たに追加された演習です。この更新のタイミングでその他の演習のサンプルコードに、この**演習で追加するコード用のコメント**が追記されています。よって、それ以前に当ハンズオンを実施された方で、作成済みの演習用ボット アプリケーションに機能を追加される方は、以下のリンクを参照してコメントの位置を確認してください。
