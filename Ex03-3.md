...
9. **lm.js**  Function Calling に使用する funcs.js に定義した関数の情報を含んだ JSON を定義するコードを追加します
...
12. 最後に、言語モデルに送信する JSON スキーマにこの手順で追記しした tools の情報を追加します
    ...
    **lm.js** ファイルに定義されている **sendMessage** 関数内のコメント ` //[PLACEHOLDER:functionCalling tools:]` を以下と置き換えます
...
10. 追加したコードが正しく動作するか確認します
 ...
 URL にアクセスして画像が表示されることを確認します。
    ...
    * [**画像生成モデルの関数を追加した lm.js**](samples/ml_3.js)
