...
> [!NOTE]
> 現在、DALL-E 3 モデルよりも新しい GPT-image-1 モデルがプレビュー利用可能になっています。[**演習 1. 4 :  画像生成モデル gpt-image-1 のデプロイ**](Ex01-4_gpt-image.md) を実施しており DALL-E 3 モデルの代わりに gpt-image-1 モデルを使用する場合は以下のタスクに分岐します。
